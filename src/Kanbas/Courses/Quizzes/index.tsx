    ...
    <div id="wd-quizzes">
      <li className="wd-quizzes-list list-group-item p-0 m-5 fs-5 border-gray ">
          ...
          <div className="icon-container">
            ...
            <div className="right-icons">
              {currentUser.role === "FACULTY" && (
                <button
                  className="btn btn-lg btn-danger text-black me-3 rounded-1 border"
                  onClick={(e) => {
                    handleAddQuiz();
                  }}
                >
        ...
        <ul className="wd-quiz-list-item list-group rounded-0 border-5 border-start border-success">
          {quizzes
            .filter((m: any) =>
              currentUser.role === "STUDENT" ? m.published === true : m
            )
            .map((m: any) => (
                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-9 d-flex flex-column justify-content-center">
                    ...
                    <p>
                      ...
                      <span style={{ fontWeight: "bold" }}> Due</span> {m.due} |
                      points: {m.points} | {m.questionsNum} questions
                    </p>
                  </div>
                    ...
                    {currentUser.role === "FACULTY" && (
                      <div className="d-flex align-items-center">
                        {m.published ? (
                          ...
                          <FaCheckCircle
                            className="text-muted me-2 fs-4"
                            onClick={(e) => {
                              handlePublishQuiz(m);
                            }}
                          />
                        ...
                        {showOptions && menueId === m._id && (
                          <div className="dropdown-menu show">
                            <button
                              ...
                              onClick={(e) => handleEditQuiz(m)}
                            >
                              Edit
                            </button>
                            <button
                              className="dropdown-item"
                              onClick={(e) => handleDeleteQuiz(m)}
                            >
                              Delete
                            </button>
                            <button
